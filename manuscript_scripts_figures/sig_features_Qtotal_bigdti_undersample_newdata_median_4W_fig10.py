...
def main():
    ...
    for i in range(len(FM_data_path)):
        ...
        axq[i].set_xlabel('\n'.join(wrap('{} {}: {}; p_value ={:.2e}'.format(number_oder[i],well_keyword[i],column_keyword[i],pvs_Q_median),30)),fontsize=12)
    ...
    plt.tight_layout()
    plt.savefig(r'H:\UOAPC_Zdrive\MLproject\whakaari-master\Q_total\T3wells_Q_Lambda_th_{}_dti_{}d_dtj_{}d08021_4W_0605_1026.png'.format(percentile_list[0],Dti,Dtj_df),dpi=500)
    plt.show()
